...
INSERT INTO public.z01_om_plan (group_num,sub_group_num,sub_group_name,func_name,is_enable,group_name) VALUES
	 ...
	 (1,3,'WBK','zfr_wbk_hrh_list',1,'OM'),
	 (1,4,'WBK','zfr_wbk_all',1,'OM'),
	 (1,5,'DSB','zfr_clc_dir_list',1,'OM'),
	 (1,6,'DSB','zfr_clc_rep_hst',0,'OM'),
	 (1,7,'DSB','zfr_dsb_public_link',1,'OM'),
	 (1,8,'DSB','zfr_dsb_list',1,'OM'),
	 (1,9,'DSB','zfr_dsb_all',1,'OM'),
	 (1,10,'WID','zfr_wid_list',1,'OM');
INSERT INTO public.z01_om_plan (group_num,sub_group_num,sub_group_name,func_name,is_enable,group_name) VALUES
	 (1,11,'WID','zfr_wid_conf',0,'OM'),
	 (1,12,'WID','zfr_wid_all',1,'OM'),
	 (1,13,'LNK','zfr_lnk_dsb2wid',1,'OM'),
	 (1,14,'LNK','zfr_lnk_wid2ds',1,'OM'),
	 (1,15,'CON','zfr_con_list',1,'OM'),
	 (1,16,'CON','zfr_con_hist',0,'OM'),
	 (1,17,'DS','zfr_ds_ec2tableid',1,'OM'),
	 (1,18,'DS','zfr_ds_name_alias',1,'OM'),
	 (1,19,'DS','zfr_ds_list',1,'OM'),
	 (1,20,'DS','zfr_ds_server_list',1,'OM');
INSERT INTO public.z01_om_plan (group_num,sub_group_num,sub_group_name,func_name,is_enable,group_name) VALUES
	 (1,21,'DS','zfr_ds_conf',1,'OM'),
	 (1,22,'DS','zfr_ds_fields_list',1,'OM'),
	 (1,23,'DS','zfr_ds_msr_list',1,'OM'),
	 (1,24,'DS','zfr_ds_hrh_table',1,'OM'),
	 (1,25,'DS','zfr_ds_hrh_table_type',1,'OM'),
